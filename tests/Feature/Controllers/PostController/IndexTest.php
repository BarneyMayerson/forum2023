...
it("passes posts to the view", function () {
    ...
    get(route("posts.index"))->assertHasPaginatedResource(
        "posts",
...
it("passes topics to the view", function () {
    ...
    get(route("posts.index"))->assertHasResource(
        "topics",
...
it("can filter to a topic", function () {
    ...
    get(
        route("posts.index", ["topic" => $general])
...
it("passes the selected topic to the view", function () {
    ...
    get(route("posts.index", ["topic" => $topic]))->assertHasResource(
        "selectedTopic",
